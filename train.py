...
def main():
    ...
    # 训练集
    train_set = YoloDataset(cfg.train_list, (cfg.img_h, cfg.img_w), mosaic=cfg.mosaic)
    ...
    # 测试集
    test_set = YoloDataset(cfg.test_list, (cfg.img_h, cfg.img_w), mosaic=cfg.mosaic)
    ...
    for epoch in range(start_epoch, cfg.num_epochs + 1):
        ...
        if epoch % cfg.valinterval == 0:
            ...
            torch.save(model.state_dict(), f"./{cfg.output}/yolov4.voc.{epoch}.pt")
